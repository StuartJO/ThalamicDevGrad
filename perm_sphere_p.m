...
rho_null_xy = corr(x_perm,y,'type',corr_type, 'Rows', 'pairwise');
rho_null_yx = corr(y_perm,x,'type',corr_type, 'Rows', 'pairwise');
% rho_null_xy = zeros(nperm,1);
% rho_null_yx = zeros(nperm,1);
% for r = 1:nperm
%     rho_null_xy(r) = corr(x_perm(:,r),y,'type',corr_type, 'Rows', 'complete'); % correlate permuted x to unpermuted y
%     rho_null_yx(r) = corr(y_perm(:,r),x,'type',corr_type, 'Rows', 'complete'); % correlate permuted y to unpermuted x
% end
